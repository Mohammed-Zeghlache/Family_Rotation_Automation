...
//       console.log(`✅ Found browser: ${candidate}`);
//       return candidate;
//     }
//   }
//   return null;
...
// if (!chromePath) {
//   console.log('❌ No browser found! Install Chrome: https://www.google.com/chrome/');
//   console.log('   Or set PUPPETEER_EXECUTABLE_PATH in your .env file.');
//   process.exit(1);
// }
...
//   if (!isReady) {
//     console.log('⏳ WhatsApp not ready yet. Will send PDF when connected...');
...
//       console.log('📤 Will send on startup instead...');
//       oneTimeScheduled = true;
//       sendScheduleFor(DEFAULT_SEND_MONTH, DEFAULT_SEND_YEAR);
//       return;
//     }
...
//       console.log(`📅 Will send ${MONTH_NAMES[DEFAULT_SEND_MONTH - 1]} ${DEFAULT_SEND_YEAR} PDF`);
//       oneTimeScheduled = true;
      
//       setTimeout(async () => {
//         console.log(`📤 Sending scheduled ${MONTH_NAMES[DEFAULT_SEND_MONTH - 1]} ${DEFAULT_SEND_YEAR} PDF...`);
//         await sendScheduleFor(DEFAULT_SEND_MONTH, DEFAULT_SEND_YEAR);
//         console.log('✅ Scheduled PDF sent!');
//       }, delay);
//       return;
//     } else {
//       console.log('⏰ SEND_AT already passed — sending now...');
//     }
//   } else {
//     console.log('📤 No SEND_AT set. Will send on startup when WhatsApp is ready...');
//   }
  
//   // Send immediately (or when WhatsApp is ready)
//   oneTimeScheduled = true;
//   sendScheduleFor(DEFAULT_SEND_MONTH, DEFAULT_SEND_YEAR);
// }

// // ============================================================
// //  MONTHLY SCHEDULER - PDF ONLY
// // ============================================================
...
//     console.log(`📅 Monthly job: sending ${MONTH_NAMES[month - 1]} ${year} PDF`);
//     await sendScheduleFor(month, year);
//   },
//   { timezone: TIMEZONE }
// );

// console.log(`⏰ Monthly send scheduled: "0 8 1 * *" (${TIMEZONE})`);
...
//   console.log(`\n📤 Will send ${MONTH_NAMES[DEFAULT_SEND_MONTH - 1]} ${DEFAULT_SEND_YEAR} PDF`);
//   console.log(`   (when WhatsApp connects or at scheduled time)\n`);
...
// ============================================================
//  MONTHLY SCHEDULER - Send 3 days before month end
// ============================================================

cron.schedule(
  '0 21 08 * *',  // Runs at 8:00 AM on the 9th of every month
  async () => {
    const { month, year } = getNextMonthYear();
    console.log(`📅 Monthly job: sending ${MONTH_NAMES[month - 1]} ${year} PDF (3 days early)`);
    await sendScheduleFor(month, year);
  },
  { timezone: TIMEZONE }
);

console.log(`⏰ Monthly send scheduled: "0 21 08 * *" (${TIMEZONE}) - Sends next month's PDF on the 9th`);
...
app.listen(PORT, () => {
  ...
  console.log(`👀 Preview the calendar at /api/schedule/preview`);
  const { month, year } = getNextMonthYear();
  console.log(`\n📤 Will send ${MONTH_NAMES[month - 1]} ${year} PDF on the 9th of each month (3 days early)`);
